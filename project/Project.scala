...
object EpicBuild extends Build {
  ...
  lazy val allModels = Project("epic-all-models", file("."), settings = buildSettings) aggregate (epicParserLexEnglish, epicModelCore) dependsOn (epicParserLexEnglish, epicModelCore)
